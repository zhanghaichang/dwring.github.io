---
layout: post
title: Java多线程处理任务的封装
category: java
tags: [java]
---

最近公司项目很多地方使用多线程处理一些任务，逻辑代码和[java多线程](http://www.codeceo.com/article/java-immutable-object.html "java多线程")处理代码混合在一起，造成代码的可读性超级差，现在把Java多线程相关的处理抽出来，方面代码中重复使用。抽的不好，欢迎大家拍砖
